...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMS.DataManager.EntityFrameworkCore.Tests.Blogs.Comment", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MMS.DataManager.EntityFrameworkCore.Tests.Blogs.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MMS.DataManager.EntityFrameworkCore.Tests.Entities.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MMS.DataManager.EntityFrameworkCore.Tests.Blogs.Comment", b =>
                {
                    b.HasOne("MMS.DataManager.EntityFrameworkCore.Tests.Blogs.Post", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("MMS.DataManager.EntityFrameworkCore.Tests.Blogs.Post", b =>
                {
                    b.HasOne("MMS.DataManager.EntityFrameworkCore.Tests.Entities.Blogs.Blog", null)
                        .WithMany("Posts")
