...
namespace Microsoft.AspNetCore.Builder
{
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </example>
        /// </summary>
        public static IApplicationBuilder UseDataManagerRequestLocalization(this IApplicationBuilder app)
        {
            if (app == null)
            {
            ...
            return app.UseAbpRequestLocalization(options =>
            {
                ...
                // 添加header解析器
                options.RequestCultureProviders.Add(new DataManagerAcceptLanguageHeaderRequestCultureProvider());
            });
        }
    }
}